...
Optional environment variables: **`LAO_VERSION`** (pin a release, e.g. `3.0.12`), **`LAO_PACKAGE`** (override PyPI name).
...
Full release notes: **[CHANGELOG.md](CHANGELOG.md)** (latest: `v3.0.12`; Pilot highlights in `v3.0.4`).
